...
export default async function DashboardPage() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            {/* Welcome Banner */}
            <div className="bg-linear-to-r from-forest to-[#1B5E20] p-8 rounded-2xl shadow-xl flex justify-between items-center text-white border border-growth/30 relative overflow-hidden">
                ...
                <div className="absolute right-0 top-0 w-64 h-64 bg-growth rounded-full blur-[100px] opacity-20 -mr-16 -mt-16"></div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="bg-[#5D4037]/40 p-6 rounded-xl border border-[#5D4037] hover-lift transition-all hover:bg-[#5D4037]/60 cursor-default group">
                            <div className="flex items-center gap-3 mb-2 text-gray-400 group-hover:text-sun transition-colors">
                    ...
                    <div>
                        ...
                        <div className="grid gap-4">
                            <Link href="/quiz" className="block group">
                                <div className="bg-forest/10 hover:bg-forest/20 border border-forest p-6 rounded-xl transition-all group-hover:transform group-hover:scale-[1.01] flex justify-between items-center">
                                    <div>
                                        <h4 className="text-lg font-bold text-growth group-hover:text-sun transition-colors">Computer Science Basics</h4>
                                        <p className="text-sm text-gray-400">Master the fundamentals of binary and logic.</p>
                                    </div>
                                    <span className="px-4 py-2 bg-forest text-white rounded-full text-sm font-bold">Start +50 XP</span>
                                </div>
                            </Link>
